...
struct SCOFF_ImageDirAddress {
// : public SCOFF_IMAGE_DATA_DIRECTORY 
   uint32 VirtualAddress;              // Image relative address of table
   uint32 Size;                        // Size of table
...
union SCOFF_OptionalHeader {
   ...
   struct {
      ...
      // Data directories
      struct SCOFF_IMAGE_DATA_DIRECTORY ExportTable;
      struct SCOFF_IMAGE_DATA_DIRECTORY ImportTable;
      struct SCOFF_IMAGE_DATA_DIRECTORY ResourceTable;
      struct SCOFF_IMAGE_DATA_DIRECTORY ExceptionTable;
      struct SCOFF_IMAGE_DATA_DIRECTORY CertificateTable;
      struct SCOFF_IMAGE_DATA_DIRECTORY BaseRelocationTable;
      struct SCOFF_IMAGE_DATA_DIRECTORY Debug;
      struct SCOFF_IMAGE_DATA_DIRECTORY Architecture;   // 0
      struct SCOFF_IMAGE_DATA_DIRECTORY GlobalPtr;      // 0
      struct SCOFF_IMAGE_DATA_DIRECTORY TLSTable;
      struct SCOFF_IMAGE_DATA_DIRECTORY LoadConfigTable;
      struct SCOFF_IMAGE_DATA_DIRECTORY BoundImportTable;
      struct SCOFF_IMAGE_DATA_DIRECTORY ImportAddressTable;
      struct SCOFF_IMAGE_DATA_DIRECTORY DelayImportDescriptor;
      struct SCOFF_IMAGE_DATA_DIRECTORY CLRRuntimeHeader;
      struct SCOFF_IMAGE_DATA_DIRECTORY Reserved;       // 0
   } h32;
   // 64 bit version
   struct {
      uint16 Magic;                    // Magic number
